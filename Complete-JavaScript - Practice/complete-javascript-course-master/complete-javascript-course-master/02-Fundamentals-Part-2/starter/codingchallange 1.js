...
// 3. Apply this to the team's average scores
// GOOD LUCK
...
// Test 1
let scoreDolphins = calcAverage(44, 23, 73);
...
const checkWinner = function (avgDolphins, avgKoalas) {
  if (avgDolphins >= 2 * avgKoalas) {
    console.log(
      `Dolphins wins the game. (${avgDolphins} vs.  ${avgKoalas})`
    );
  } else if(avgKoalas >= 2 * avgDolphins){
    console.log(
        `Koalas are wins the game. (${avgKoalas} vs.  ${avgDolphins})`
      );
  } else{
